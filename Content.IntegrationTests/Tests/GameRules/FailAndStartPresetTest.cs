...
";
    ...
    public async Task FailAndStartTest()
    {
        ...
        Assert.That(server.CfgMan.GetCVar(CCVars.GameLobbyDefaultPreset), Is.EqualTo("nftest")); // Frontier secret>nftest
        ...
        server.CfgMan.SetCVar(CCVars.GameLobbyDefaultPreset, "nftest"); // Frontier secret>nftest
