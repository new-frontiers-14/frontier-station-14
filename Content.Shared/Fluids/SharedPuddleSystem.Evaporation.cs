...
public abstract partial class SharedPuddleSystem
{
    ...
    private static readonly ProtoId<ReagentPrototype> DirtyWater = "DirtyWater"; // Frontier: evaporates, not usable as mop water

    // Frontier: NOTE: if updating this list, keep up to date with AbsorbentSystem.MopFriendlyReagents
    public static readonly string[] EvaporationReagents = [Water, Holywater, Ice, SodaWater, DirtyWater]; // Frontier
