...
public abstract partial class SharedPuddleSystem
{
    ...
    private static readonly ProtoId<ReagentPrototype> BloodGoblin = "BloodGoblin"; // Frontier

    // Frontier: NOTE: if updating this list, keep up to date with AbsorbentSystem.EvaporationReagents
    public static readonly string[] EvaporationReagents = [Water, Vomit, Holywater, InsectBlood, AmmoniaBlood, ZombieBlood, Blood, Slime, CopperBlood, FluorosulfuricAcid, Sap, Syrup, JuiceTomato, Fiber, Nothing, BloodGoblin]; // Frontier
