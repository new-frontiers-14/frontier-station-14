...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> StaticStorageUI =
        CVarDef.Create("control.static_storage_ui", true, CVar.CLIENTONLY | CVar.ARCHIVE); // Frontier: FIXME, setting this to false actully breaks StorageInteractionTest, since its client settings we can let it be.
