...
public sealed partial class PlantMutateConvertGases : EventEntityEffect<PlantMutateConvertGases>
{
    ...
    /// <summary>
    /// A weighted random prototype for how rare each kind of gas mutation should be.
    /// </summary>
    [DataField]
    public ProtoId<WeightedRandomPrototype> NFGasConversionsWeightPrototype = "NFRandomGasConversions";
