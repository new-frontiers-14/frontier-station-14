...
/// </summary>
[RegisterComponent, NetworkedComponent, Access(typeof(SharedFrontierCargoSystem))]
public sealed partial class FrontierCargoTelepadComponent : Component
{
    /// <summary>
    ...
    public FrontierCargoTelepadState CurrentState = FrontierCargoTelepadState.Unpowered;
