...
namespace Content.Shared._NF.Cargo.Prototypes;

/**
 * Basically a copy of the original CargoProductPrototype.
 * Reason for this is so that new cargo products are not automatically added to frontier,
 * and is modifiable and exclusive to frontier's cargo system.
 */
[Prototype]
public sealed class FrontierCargoProductPrototype : IPrototype, IInheritingPrototype
{
    /// <inheritdoc />
    [ParentDataField(typeof(AbstractPrototypeIdArraySerializer<FrontierCargoProductPrototype>))]
