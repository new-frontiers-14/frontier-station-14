...
/// </summary>
[ByRefEvent]
public readonly record struct ThrowHitByEvent(EntityUid? Thrower, EntityUid Thrown, EntityUid Target, ThrownItemComponent Component); // Frontier: Add thrower

/// <summary>
/// Raised directed on the thrown entity that hits another.
/// </summary>
[ByRefEvent]
public readonly record struct ThrowDoHitEvent(EntityUid? Thrower, EntityUid Thrown, EntityUid Target, ThrownItemComponent Component); // Frontier: Add thrower
