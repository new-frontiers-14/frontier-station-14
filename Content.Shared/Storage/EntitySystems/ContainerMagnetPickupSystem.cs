...
/// <summary>
/// <see cref="ContainerMagnetPickupComponent"/>
/// </summary>
public sealed class ContainerMagnetPickupSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ContainerMagnetPickupComponent, MapInitEvent>(OnMagnetMapInit);
        SubscribeLocalEvent<ContainerMagnetPickupComponent, EntityUnpausedEvent>(OnMagnetUnpaused);
    }

    private void OnMagnetUnpaused(EntityUid uid, ContainerMagnetPickupComponent component, ref EntityUnpausedEvent args)
    {
        component.NextScan += args.PausedTime;
    }

    private void OnMagnetMapInit(EntityUid uid, ContainerMagnetPickupComponent component, MapInitEvent args)
    {
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<ContainerMagnetPickupComponent, StorageComponent, TransformComponent>();
        ...
        while (query.MoveNext(out var uid, out var comp, out var storage, out var xform))
        {
            ...
            // Check if magnet should be active in current anchor state
            if (xform.Anchored && !comp.PickupWhenAnchored || !xform.Anchored && !comp.PickupWhenNotAnchored)
                continue;
