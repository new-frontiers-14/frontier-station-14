...
When we port content from other forks, we organize their content to repo-specific subfolders to better track attribution and limit merge conflicts.

Content under these subdirectories originate from their respective forks and may contain modifications. These modifications are denoted by comments on or around the modified lines. Note that, except for _Emberfall, all code is relicensed under AGPLv3 (at or after 2fca06eaba205ae6fe3aceb8ae2a0594f0effee0, see the License section above).
...
*The _Emberfall directory is licensed under MPLv2 as stated in the License section.
