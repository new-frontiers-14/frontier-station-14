...
public sealed partial class LimbSystem : SharedLimbSystem
{
    ...
    public bool AttachLimb(Entity<HumanoidAppearanceComponent> body, string slot, Entity<BodyPartComponent> part,
        Entity<BodyPartComponent> limb)
    {
    ...
    public bool AttachItem(EntityUid body, string slot, Entity<BodyPartComponent> part, Entity<MetaDataComponent> item)
    {
        ...
        _body.SetPartType(virtualItem, BodyParts.GetBodyPart(slot), virtualBodyPart);
    ...
    public void Amputatate(Entity<TransformComponent, HumanoidAppearanceComponent, BodyComponent> body,
    ...
    private void AmputateItemLimb(Entity<TransformComponent, BodyComponent> body,
        Entity<TransformComponent, MetaDataComponent, BodyPartComponent> limb, string slotId,
        CustomLimbComponent virtualLimb)
    {
