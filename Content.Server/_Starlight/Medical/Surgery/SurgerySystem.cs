...
public sealed partial class SurgerySystem : SharedSurgerySystem
{
    ...
    private void AddSurgeries(EntityUid part, EntityUid body,
        Dictionary<NetEntity, List<(EntProtoId, string suffix, bool isCompleted)>> surgeries)
    {
        ...
        foreach (var surgery in _surgeries)
        {
            ...
            if (!progress.StartedSurgeries.Contains(surgery) && !isCompleted)
            {
