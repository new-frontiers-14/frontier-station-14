...
public sealed partial class NFGridSpawnComponent : Component
{
    /// <summary>
    /// Dictionary of groups where each group will have entries selected.
    /// String is just an identifier to make yaml easier.
    /// </summary>
    [DataField(required: true)] public Dictionary<string, IGridSpawnGroupNF> Groups = new();
}

public interface IGridSpawnGroupNF
{
    /// <summary>
...
[DataRecord]
public sealed class NFDungeonSpawnGroup : IGridSpawnGroupNF
{
    /// <summary>
...
[DataRecord]
public sealed class NFGridSpawnGroup : IGridSpawnGroupNF
{
