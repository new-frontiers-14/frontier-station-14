...
public sealed class MutationSystem : EntitySystem
{
    ...
    public void MutateSeed(ref SeedData seed, float severity)
    {
        ...
        //MutateBool(ref seed.Bioluminescent, true , 10, totalbits, severity); // Frontier
        MutateBool(ref seed.TurnIntoKudzu , true , 10, totalbits, severity);
        MutateBool(ref seed.CanScream     , true , 10, totalbits, severity);
        //seed.BioluminescentColor = RandomColor(seed.BioluminescentColor, 10, totalbits, severity); // Frontier
