...
public sealed class GCQueuePrototype : IPrototype
{
    ...
    /// <summary>
    ///     How many miliseconds to spend deleting objects per object in the queue above the MinDepth? Mono Dynamic Queueing. This does not override the overall GCQueueSystem timer.
    /// </summary>
    [DataField]
    public double TimeDeletePerObject { get; } = 0.1; // Mono - at 100 objects past the MinDepth will spend up to 10 milliseconds trying to do deletion. 
