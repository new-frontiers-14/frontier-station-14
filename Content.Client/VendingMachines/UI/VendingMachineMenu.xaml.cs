...
namespace Content.Client.VendingMachines.UI
{
    ...
    public sealed partial class VendingMachineMenu : FancyWindow
    {
        ...
        private readonly SharedPricingSystem _pricingSystem;
        private readonly Dictionary<EntProtoId, EntityUid> _dummies = [];

        public event Action<ItemList.ItemListSelectedEventArgs>? OnItemSelected;
        public event Action<string>? OnSearchChanged;

        public VendingMachineMenu(SharedPricingSystem pricingSystem)
        {
        ...
        public void Populate(List<VendingMachineInventoryEntry> inventory, float priceModifier, out List<int> filteredInventory,  string? filter = null)
        {
            ...
            for (var i = 0; i < inventory.Count; i++)
            {
                ...
                if (prototype != null)
                {
                    var vendPrice = _pricingSystem.GetEstimatedVendPrice(prototype);
                    if (vendPrice > 0.0)
                        cost = (int) vendPrice;
                    else
                        cost = (int) (_pricingSystem.GetEstimatedPrice(prototype) * priceModifier);
                }
                else
