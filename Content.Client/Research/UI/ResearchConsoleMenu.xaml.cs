...
public sealed partial class ResearchConsoleMenu : FancyWindow
{
    ...
    public void UpdatePanels(ResearchConsoleBoundInterfaceState state)
    {
        ...
        foreach (var techId in database.CurrentTechnologyCards)
        {
            ...
            // Frontier: add costModifier
            var cardControl = new TechnologyCardControl(tech, _prototype, _sprite, _research.GetTechnologyDescription(tech, includeTier: false, costModifier: state.CostModifier), state.Points, hasAccess);
