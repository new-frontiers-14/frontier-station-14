...
using TemperatureCondition = Content.Shared.EntityEffects.EffectConditions.Temperature; // Frontier: We don't have the entity effects refactor. This is needed to disambiguate the class from the namespace.
