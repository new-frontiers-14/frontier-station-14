using System.Linq;
using Content.Client._NF.Cargo.Systems;
...
namespace Content.Client._NF.Cargo.UI
{
    ...
    public sealed partial class NFCargoConsoleMenu : FancyWindow
    {
        ...
        private readonly NFCargoSystem _cargoSystem;
        private readonly SpriteSystem _spriteSystem;
        private EntityUid _owner;
        private EntityUid? _station;

        private readonly EntityQuery<NFCargoOrderConsoleComponent> _orderConsoleQuery;
        ...
        public NFCargoConsoleMenu(EntityUid owner, IEntityManager entMan, IPrototypeManager protoManager, SpriteSystem spriteSystem)
        {
            ...
            _cargoSystem = entMan.System<NFCargoSystem>();
            _spriteSystem = spriteSystem;
            _owner = owner;

            _orderConsoleQuery = _entityManager.GetEntityQuery<NFCargoOrderConsoleComponent>();
