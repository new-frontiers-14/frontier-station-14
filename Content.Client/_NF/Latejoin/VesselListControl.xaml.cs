...
public sealed partial class VesselListControl : BoxContainer
{
    ...
    private int DefaultComparison(NetEntity x, NetEntity y)
    {
        ...
        if (_gameTicker.StationNames[x] == "Frontier Outpost" && _gameTicker.StationNames[y] != "Frontier Outpost")
        {
            return -1;
        }
        else if (_gameTicker.StationNames[x] != "Frontier Outpost" && _gameTicker.StationNames[y] == "Frontier Outpost")
        {
            return 1;
        }
