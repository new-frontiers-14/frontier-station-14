    ...
    public sealed class ClientPreferencesManager : IClientPreferencesManager
    {
        ...
        public void SetCharacterEnable(int slot, bool enable = true)
        {
            ...
            Preferences = new PlayerPreferences(characters, Preferences.SelectedCharacterIndex, Preferences.AdminOOCColor,
                Preferences.ConstructionFavorites, Preferences.JobPriorities);
        ...
        {
            Preferences = new PlayerPreferences(Preferences.Characters, Preferences.SelectedCharacterIndex, Preferences.AdminOOCColor,
                Preferences.ConstructionFavorites, jobPriorities);
        ...
        {
            Preferences = new PlayerPreferences(Preferences.Characters, Preferences.SelectedCharacterIndex, Preferences.AdminOOCColor,
                favorites, Preferences.JobPriorities);
