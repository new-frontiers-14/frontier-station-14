...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private void SetSpecies(string newSpecies)
        {
            ...
            if (Profile != null && !speciesPrototype.Sexes.Contains(Profile.Sex)) //if the existing profile had a set sex that is invalid for the new species, set it to one that is valid.
            {
