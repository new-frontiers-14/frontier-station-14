...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private List<VoicePrototype> _voices = new();
        private List<VoicePrototype> _siliconVoices = new();
            ...
            MarkingManager markings)
        {
            ...
            SiliconVoicePreviewButton.Disabled = true;
        }
        ...
        public void RefreshSpecies()
        {
            ...
            var allowedSpecies = new HashSet<string>
            {
                "resomi",
                "shadekin",
                "felionoid",
            ...
            _species.AddRange(_prototypeManager
                ...
                .Where(o => o.RoundStart && allowedSpecies.Contains(o.ID.ToLowerInvariant())));
        ...
        private void UpdateSizeText()
        {
            ...
            if (_prototypeManager.TryIndex<SpeciesPrototype>(Profile.Species, out var speciesPrototype))
            {
                ...
                var weight = speciesPrototype.StandardWeight +
                             speciesPrototype.StandardDensity * (Profile.Appearance.Width * Profile.Appearance.Height * Profile.Appearance.Height - 1);
