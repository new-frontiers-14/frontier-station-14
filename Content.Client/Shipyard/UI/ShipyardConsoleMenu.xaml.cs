...
public sealed partial class ShipyardConsoleMenu : FancyWindow
{
    ...
    {
        BalanceLabel.Text = Loc.GetString("cargo-shipyard-console-bank-amount", ("amount", state.Balance.ToString()));
        ShipAppraisalLabel.Text = Loc.GetString("cargo-shipyard-console-sell-value", ("value", state.ShipSellValue.ToString()));
