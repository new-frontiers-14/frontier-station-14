...
book-text-delightsandmusings = [head=3] Delights and Musings[/head]
        ...
        Gather a few handfuls of nettles. Wear botanical gloves when harvesting! Blanch by boiling the nettles thoroughly and plunging into ice cold water to remove their stinging properties, then finely chop. In a large pot, boil 4 smallish potatoes. Drain the old water to rid the potato starch and add 10 units of fresh water. Add your chopped nettles and pureé with whatever method you wish(a reagent grinder does the trick). Simmer the soup for 20-30 minutes, then carefully add one egg while stirring vigorously to ensure it incorporates evenly. Salt well, but to taste. I prefer using coarse salt for the best flavour.
