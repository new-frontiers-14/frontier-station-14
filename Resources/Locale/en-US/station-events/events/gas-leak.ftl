...
## Frontier
station-event-gas-leak-start-announcement = Attention. A gas leak has been detected onboard a shuttle. Affected personnel are advised to avoid the area and wear suit internals in the meantime.
station-event-gas-leak-end-announcement = The source of the gas leak has been fixed. Please be cautious around areas with gas remaining.