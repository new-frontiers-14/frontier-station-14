...
ent-MobRogueSiliconAISimpleRanged = { "" }
    .desc = { "" }
ent-MobRogueSiliconTimedDespawn = { "" }
    .desc = { "" }
...
ent-MobRogueSiliconHerder = herder unit
    .desc = This rogue silicon units primary directive is to corral and herd captives. Its stun prod can be used to good effect, take caution.
...
ent-MobRogueSiliconTesla = tesla unit
    .desc = Originally designed to service tesla power generators, this silicons equipment has been repurposed as a makeshift stun gun.
ent-MobRogueSiliconGuardian = guardian unit
    .desc = An advanced security silicon, typically used to safeguard high-security areas such as vaults and server rooms. After being hacked, this unit carries out the AIs will.
ent-MobRogueSiliconBoss = one star unit
    .desc = An autonomous combat-grade mech, typically used for offensive operations. Now a rogue AIs elite guard. Equipped with missile launchers, exercise extreme caution.
