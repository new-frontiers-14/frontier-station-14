...
ent-ShuttleGunDusterCircuitboard = EXP-2100g "Duster" machine board
    ...
    .suffix = DO NOT MAP, Machine Board
ent-ShuttleGunKineticCircuitboard = PTK-1500e "Matter Dematerializer" machine board
    .desc = A machine printed circuit board for an PTK-1500e "Matter Dematerializer".
    .suffix = DO NOT MAP, Machine Board
