...
humanoid-profile-editor-naming-rules-warning = Warning: Offensive IC names and descriptions will lead to admin intervention on this server. Read our \[Rules\] for more.
