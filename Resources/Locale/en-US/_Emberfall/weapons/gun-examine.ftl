...
# gun-examine-recoil = - [color={$color}]Recoil[/color]: [color=lightblue]{NATURALFIXED($value, 1)}°[/color] per shot
# gun-examine-stability = - [color={$color}]Stability[/color]: [color=lightblue]{NATURALFIXED($value, 1)}°[/color] per second
...
gun-examine-caliber-50 = .50 shell ammo
