...
plant-analyzer-plant-convert-text = Gas Conversions: {$seedGasConversions}
plant-analyzer-plant-gasconversion-entry = {$amount} mol {$inputGas} -> {$outputGas} ({$scaleFactor}x)
