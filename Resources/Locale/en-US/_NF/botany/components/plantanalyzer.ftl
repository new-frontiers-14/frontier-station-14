...
plant-analyzer-plant-exude-text = Gas emissions: {$gases}
plant-analyzer-plant-consume-text = Gas consumption: {$gases}
...
plant-analyzer-tolerance-heat-tolerance = Heat tolerance: {$heatTolerance}
plant-analyzer-tolerance-ideal-light = Ideal light: {$idealLight}
plant-analyzer-tolerance-light-tolerance = Light tolerance: {$lightTolerance}
