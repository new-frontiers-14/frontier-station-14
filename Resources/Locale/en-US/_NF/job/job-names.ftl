...
job-name-contractor-interview = Contractor (Interview)
...
job-name-mercenary-interview = Mercenary (Interview)
job-name-pal = Public Affairs Liaison
job-name-pilot = Pilot
job-name-pilot-interview = Pilot (Interview)
...
JobContractorInterview = Contractor (Interview)
JobERTMailCarrier = ERT Mail Carrier
JobMercenary = Mercenary
JobMercenaryInterview = Mercenary (Interview)
JobPilot = Pilot
JobPilotInterview = Pilot (Interview)
JobPirate = Pirate
