...
station-event-bluespace-syndicate-ftl-interception-start-announcement = Attention all Security personnel! NT Naval Command disrupted the FTL-jump of Syndicate Vessel, according to our deepspace scanners the vessel either already entered the real space in your sector or is about to enter. Security Code: Intercept, Expunge, Exterminate, Cauterise. Expect armed opposition, use of lethal force against enemy agents is authorized. Prevent NT-affiliated captains without security access from gaining access to the enemy vessel and its contents.
...
station-event-bluespace-wizardfederation-scout-start-announcement = Attention all available NT personnel! NT Naval Command detected blue anomaly in your sector with the signature indicative of imminent arrival of a Wizard Federation micro vessel. Code: Intercept, Detain, Incarcerate. Arrest the intruders and prepare them to be handed over to NT Special Forces Unit for enhanced interrogation.
