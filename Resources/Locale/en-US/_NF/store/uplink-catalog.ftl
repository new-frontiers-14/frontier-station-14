...
uplink-pirate-grapeshot-desc = A chest full of cluster ball made to shoot a wide range of small projectiles.
uplink-pirate-glassshot-name = Glassshot Chest
uplink-pirate-glassshot-desc = A chest full of brittle glass ball that will fire multiple projectiles in a tight spread.
...
uplink-pirate-shotgunammo-name = .50 Slug Box
uplink-pirate-shotgunammo-desc = A box of .50 slugs.
uplink-pirate-revolverammo-name = .45 Magnum Box
uplink-pirate-revolverammo-desc = A box of .45 magnum rounds.
uplink-pirate-flintlockammo-name = .60 Anti-Material Box
uplink-pirate-flintlockammo-desc = A box of .60 anti-material rounds.
