...
uplink-security-hardsuit-desc = A lightly armored suit that protects from the danger of space, standard issue to be worn by NFSD on patrol. This bronze variant has cadet rank markings.
uplink-security-hardsuit-patrol-name = Silver Patrol Suit
uplink-security-hardsuit-patrol-desc = A lightly armored suit that protects from the danger of space, standard issue to be worn by NFSD on patrol. This silver variant has standard rank markings.
uplink-security-hardsuit-brigmedic-name = Brigmedic Patrol Suit
uplink-security-hardsuit-brigmedic-desc = A lightly armored suit that protects from the danger of space, standard issue to be worn by NFSD on patrol. This specialized variant has brigmedic rank markings.
uplink-security-hardsuit-warden-name = Gold Patrol Suit
uplink-security-hardsuit-warden-desc = A lightly armored suit that protects from the danger of space, standard issue to be worn by NFSD on patrol. This gold variant has supervisor rank markings.
uplink-security-hardsuit-experimental-name = Experimental Combat Suit
uplink-security-hardsuit-experimental-desc = A very heavily armored NFSD suit. This experimental and very expensive space proof marvel of engineering uses state of the art alloys to provide immense protection without sacrificing too much more mobility compared to the standard combat suits.
uplink-security-hardsuit-sheriff-name = Sheriff's Patrol Suit
uplink-security-hardsuit-sheriff-desc = A lightly armored suit that protects from the danger of space, standard issue to be worn by NFSD on patrol. This variant has sheriff rank markings.
uplink-security-hardsuit-combat-name = Patrol Combat Suit
uplink-security-hardsuit-combat-desc = A more heavily armored NFSD suit. Still space proof, but with much better armor plating, at the expense of mobility.
uplink-security-hardsuit-commmand-name = Command Combat Suit
uplink-security-hardsuit-commmand-desc = A more heavily armored NFSD suit. Still space proof, but with much better armor plating, at the expense of mobility. This variant has supervisor rank markings.
