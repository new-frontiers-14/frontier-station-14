...
# region Plant Manager (Edison requisitions)
store-plantmanager-screwdriver-name = Screwdriver
store-plantmanager-screwdriver-desc = A standard screwdriver for assembly and maintenance.

store-plantmanager-wrench-name = Wrench
store-plantmanager-wrench-desc = A heavy wrench for bolts and pipe fittings.

store-plantmanager-welder-name = Welding Tool
store-plantmanager-welder-desc = A handheld welding tool for cutting and sealing metal.

store-plantmanager-multitool-name = Multitool
store-plantmanager-multitool-desc = A multitool for electrical work and diagnostics.

store-plantmanager-welder-industrial-name = Industrial Welding Tool
store-plantmanager-welder-industrial-desc = An industrial welder with greater fuel capacity.

store-plantmanager-crowbar-name = Crowbar
store-plantmanager-crowbar-desc = A sturdy crowbar for prying and demolition.

store-plantmanager-cable-apc-name = LV Cable Coil
store-plantmanager-cable-apc-desc = A coil of low-voltage cable for APCs and machinery.

store-plantmanager-cable-mv-name = MV Cable Coil
store-plantmanager-cable-mv-desc = A coil of medium-voltage cable for power distribution.

store-plantmanager-cable-hv-name = HV Cable Coil
store-plantmanager-cable-hv-desc = A coil of high-voltage cable for engines and SMES.

store-plantmanager-cable-bulk-name = Bulk Cable Crate
store-plantmanager-cable-bulk-desc = A crate containing two coils each of HV, MV, and LV cable.

store-plantmanager-powercell-small-name = Small Power Cell
store-plantmanager-powercell-small-desc = A small cell for handheld devices.

store-plantmanager-powercell-medium-name = Medium Power Cell
store-plantmanager-powercell-medium-desc = A medium cell for tools and equipment.

store-plantmanager-powercell-high-name = High-Capacity Power Cell
store-plantmanager-powercell-high-desc = A high-capacity cell for power-hungry devices.

store-plantmanager-powercell-hyper-name = Hyper-Capacity Power Cell
store-plantmanager-powercell-hyper-desc = A hyper-capacity cell for heavy machinery.

store-plantmanager-meson-name = Meson Glasses
store-plantmanager-meson-desc = Safety glasses that allow you to see the layout of the station's wiring and pipes.

store-plantmanager-hardhat-name = Hard Hat
store-plantmanager-hardhat-desc = A yellow hard hat for site safety.

store-plantmanager-welding-goggles-name = Welding Goggles
store-plantmanager-welding-goggles-desc = Goggles that protect the eyes from welding glare.

store-plantmanager-hazard-vest-name = Hazard Vest
store-plantmanager-hazard-vest-desc = A high-visibility vest for hazardous environments.

store-plantmanager-insulated-gloves-name = Insulated Gloves
store-plantmanager-insulated-gloves-desc = Yellow gloves that protect against electric shock.

store-plantmanager-toolbox-electrical-name = Electrical Toolbox
store-plantmanager-toolbox-electrical-desc = A toolbox filled with electrical tools.

store-plantmanager-toolbox-mechanical-name = Mechanical Toolbox
store-plantmanager-toolbox-mechanical-desc = A toolbox filled with mechanical tools.

store-plantmanager-crate-gear-name = Engineering Gear Crate
store-plantmanager-crate-gear-desc = A crate of hard hats, mesons, hazard vests, and gloves.

store-plantmanager-crate-toolbox-name = Toolbox Crate
store-plantmanager-crate-toolbox-desc = Two mechanical and two electrical toolboxes.

store-plantmanager-foam-grenade-name = Metal Foam Grenade
store-plantmanager-foam-grenade-desc = A sealant grenade that expands into metal foam to seal breaches.
