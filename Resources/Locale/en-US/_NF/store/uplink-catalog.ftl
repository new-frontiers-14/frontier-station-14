...
uplink-security-hardsuit-warden-desc = A lightly armored suit that protects from the danger of space, standard issue to be worn by NFSD on patrol. This gold variant has command rank markings.
