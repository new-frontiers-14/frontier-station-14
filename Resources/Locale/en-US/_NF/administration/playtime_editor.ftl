...
playtime-editor-panel-warning-overflow = Error: Time value is too large (would overflow)
playtime-editor-panel-warning-invalid-time = Error: Invalid time value provided
playtime-editor-panel-warning-error = Error: Failed to update playtime
playtime-editor-panel-warning-no-perms = Error: Insufficient permissions
