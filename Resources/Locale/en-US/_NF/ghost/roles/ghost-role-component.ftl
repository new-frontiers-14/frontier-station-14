...
ghost-role-information-emotional-support-rules = You are an [color={role-type-emotional-support-pet-color}][bold]Emotional Support Pet[/bold][/color]. Support your owner, and serve your own interests.
...
ghost-role-information-clarpy-rules = You are an old [color={role-type-pirate-color}][bold]Pirate[/bold][/color] cat, help out the other pirates, and remember to take your meds.
...
ghost-role-information-cult-cat-rules = You are a [color={role-type-free-agent-color}][bold]Free Agent[/bold][/color] and free to choose your course of actions.
...
ghost-role-information-baby-dragon-rules = You are a [color={role-type-familiar-color}][bold]Familiar[/bold][/color]. Serve the interests of your new mom, whatever those may be.
                                        You don't remember any of your previous life, and you don't remember anything you learned as a ghost.
                                        You are allowed to remember knowledge about the game in general, such as how to cook, how to use objects, etc.
                                        You are absolutely [color=red]NOT[/color] allowed to remember, say, the name, appearance, etc. of your previous character.
...
ghost-role-information-dungeon-boss-rules = You are a [color={role-type-team-antagonist-color}][bold]Team Antagonist[/bold][/color] with all dungeon mobs.
