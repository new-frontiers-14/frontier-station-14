...
admin-smite-super-bonk-description = Ударить цель об каждый стол на станции.
admin-smite-super-bonk-lite-description = Бьет цель об каждый стол на станции. Прекращает свое действие только после смерти цели.
admin-smite-terminate-description = Сделать целью Терминатора.
