...
roles-antag-thief-objective = Добавьте в свою коллекцию всякие штучки от NT.
roles-antag-terminator-name = Экстерминатор
roles-antag-terminator-objective = Устраните свою цель любыми средствами, будущее рассчитывает на вас.
