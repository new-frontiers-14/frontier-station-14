...
trait-narcolepsy-desc = Вы можете случайно уснуть
trait-narcolepsy-decs = Вас одолевают приступы сонливости
trait-pacifist-desc = Вы не можете никого атаковать.
...
trait-colorblindness-desc = У вас Протанопия. Вы не можете различать цвета и цветовые оттенки пурпурной части спектра.
trait-tall-name = Высокий
trait-tall-desc = У вас есть проблема в гигантизмом.
trait-short-name = Низкий
trait-short-desc = У вас есть проблема в карликовостью.
