...
frontier-lobby-medical-subtext = Медицинский диспетчерский центр и поисково-спасательный центр.
frontier-lobby-medical-description = Медицинский диспетчерский центр компании Фронтира. Здесь вы можете:
   - Соберите или найдите бригаду медицинского реагирования
   - Общайтесь с другими медиками
   - Приобрести специализированные медицинские шаттлы
   - Получать медицинские выплаты за службу
 Некоторые роли на этой станции доступны только по белому списку. Чтобы попасть в белый список, обратитесь в Discord.
