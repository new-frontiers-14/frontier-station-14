...
medical-bounty-redemption-success-to-station = Заказ выполнен! Оплата отправлена на счета станций.
...
medical-bounty-redemption-redeem-label-valid-bounty-to-station = Значение: { $amount } (выплачивается на счета станций).
