...
ent-CrateVendingMachineRestockCiviMedVendFilled = ящик для пополнения запасов МедВенд
    .desc = Содержит две коробки для пополнения запасов в автомате МедВенд.
