...
ent-PartyNadeGun = веселящий ствол
    .desc = Нужно было выстрелить раньше.
ent-ActionThrowPartyNade = [color=yellow]Бросить веселящую гранату[/color]
    .desc = Выстреливает активированной веселящей гранатой, наполненной наркотическими химикатами, взрывается при попадании. [color=yellow]20-секундная перезарядка.[/color]
