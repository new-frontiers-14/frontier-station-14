...
ent-BaseComputerTrafficLocal = { ent-ComputerShuttle }
    .desc = { ent-ComputerShuttle.desc }
ent-ComputerShuttleFrontierOutpostLocal = консоль трафика Аванпоста Фронитира
    .desc = Следит за движением транспорта вокруг Аванпоста Фронтира.
    .suffix = Local
ent-ComputerShuttleFrontierOutpostRemote = консоль трафика Аванпоста Фронитира
    .desc = Следит за движением транспорта вокруг Аванпоста Фронтира.
    .suffix = Remote
