ent-ClothingOuterRobesWeedChurch = роба травопоклонников
    .desc = Роба для тех, чье имя бога начинается с буквы Г.
ent-ClothingHeadBeanieWeedChurch = шапочка травопоклонников
    .desc = Шапочка, которую носят травопоклонники.
ent-ClothingHeadWeedChurchBishop = шапка епископа травопоклонников
    .desc = Священный головной убор, который носят высшие чины травопоклонников.
ent-Weejurnum = ганджия
