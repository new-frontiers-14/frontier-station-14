...
ent-ClothingOuterEVASuitArcadia = скафандр EVA Аркадиа
    .desc = Аварийный скафандр EVA со встроенным шлемом. Он ужасно медленный и не имеет температурной защиты, но его достаточно, чтобы выиграть время в жестком вакууме космоса.
ent-ClothingOuterEVASuitLvhi = скафандр EVA ЛХВИ
    .desc = Костюм для выхода в открытый космос со встроенным шлемом, обычно выдаваемый персоналу компании Лангстад-Войгт Хэви Индастриз (ЛХВИ).
ent-ClothingOuterEVASuitFsb = скафандр FSB EVA
    .desc = Стандартный костюм EVA для кораблей корпорации Фар Стар Биотех. В комплект входят два подстаканникаs.
