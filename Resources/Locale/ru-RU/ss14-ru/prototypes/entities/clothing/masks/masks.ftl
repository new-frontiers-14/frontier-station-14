...
ent-ClothingMaskBlushingClown = маска краснеющего клоуна
    .desc = Маска для краснеющего клоуна.
ent-ClothingMaskBlushingMime = маска краснеющего мима
    .desc = Эти румяные щечки так и просятся, чтобы их погладили.
...
ent-ClothingMaskWeldingGas = сварочный противогаз
    .desc = Противогаз со встроенными сварочными очками и защитой лица. Выглядит как череп, явно разработанный ботаником.
