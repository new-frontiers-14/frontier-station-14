...
ent-ClothingNeckAllyPin = прямой алюминиевый штифт
    .desc = Будьте союзником и совершайте преступления.
...
ent-ClothingNeckOmnisexualPin = { ent-ClothingNeckLGBTPin }
    .desc = { ent-ClothingNeckLGBTPin.desc }
ent-ClothingNeckGenderqueerPin = гендерная булавка
    .desc = Быть преступником - делать пол.
