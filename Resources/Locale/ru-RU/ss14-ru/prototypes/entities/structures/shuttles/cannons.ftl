...
ent-ShuttleGunSvalinnMachineGun = LSE-400c "Пулемёт Свалинн"
    .desc = Базовая стационарная лазерная установка. Эффективна против живой силы и электроприборов. Для стрельбы использует обычные батареи и обладает чрезвычайно высокой скорострельностью.
