...
ent-ComputerAdvancedRadar = продвинутая консоль сканера массы
    .desc = Компьютер для отслеживания близлежащих космических тел, отображающий их позицию и массу. Благодаря новым процессорам позволяет сканировать большее пространство.
