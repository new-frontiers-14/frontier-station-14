...
ent-NFSDCriminalRecordsComputerCircuitboard = консоль криминальных записей ДСБФ (консольная плата)
    .desc = Консольная плата для консоли криминальных записей.
...
ent-RadarConsoleCircuitboard = консоль сканера массы (консольная плата)
    .desc = { ent-BaseComputerCircuitboard.desc }
ent-AdvancedRadarConsoleCircuitboard = продвинутый радар (консольная плата)
    .desc = { ent-BaseComputerCircuitboard.desc }
ent-NFSDAdvancedRadarConsoleCircuitboard = продвинутый радар ДСБФ (консольная плата)
    .desc = { ent-BaseComputerCircuitboard.desc }
