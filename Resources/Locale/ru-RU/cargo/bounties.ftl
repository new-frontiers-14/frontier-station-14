...
bounty-description-anomaly-core = Станция из ближайшего сектора запрашивает Аномальные Ядра для выполнения своей Цели. Помогите им! Слава НТ!
bounty-description-borg-module = На станции в соседнем секторе проводится эксперимент по замене всего экипажа боргами. Предоставьте им комплектующие для запасных "сотрудников"!
bounty-description-artifact-fragment = Для обучения подрастающего поколения ученых требуются фрагменты артефактов. Пришлите столько, сколько возможно.
bounty-description-organs = Колония Арахнидов заказывает комплект органов. Официальная причина: "Для изучения сходств и различий между нашими видами".
bounty-description-labeler = В связи с бюрократической ошибкой партия из нескольких сотен контейнеров с морковью была отправлена в колонию Унатхов. Нам срочно нужны ручные этикеровщики, что перераспределить поставку по новым адресатам.
bounty-description-warm-cloth = На планете Унатхов случилось внезапное похолодание. Скорее пришлите им тёплой одежды!
bounty-description-battery = Колония Арахнидов переходит на экологически чистые источники питания, в связи с чем запрашивает большую партию батарей.
bounty-description-lasergun = Очередная группа Пустотников запрашивает лазерное оружие для борьбы с агрессивной ксено-фауной.
bounty-description-food = Одна из колоний осталась без запасов провианта после вторжения крыс. Помогите им!
