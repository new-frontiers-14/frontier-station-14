...
atmos-monitoring-window-show-gas-pipe-sensors = Датчики для газопроводов
atmos-monitoring-window-label-gases = Присутствующие газы
atmos-monitoring-window-flavor-left = Обратитесь за помощью к специалисту по атмосферным устройствам
