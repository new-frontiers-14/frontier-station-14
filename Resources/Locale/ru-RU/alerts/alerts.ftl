...
alerts-magboots-desc = Вас не опрокинуть, но теперь вы слегка медлительнее.
alerts-revenant-essence-name = Эссенция
alerts-revenant-essence-desc = Духовная сила. Используется для применения способностей. Восстанавливается со временем.
alerts-revenant-corporeal-name = Телесный
alerts-revenant-corporeal-desc = Вы проявились физически. Все люди видят вас.
