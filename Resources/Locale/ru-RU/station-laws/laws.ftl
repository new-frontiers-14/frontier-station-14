...
law-ninja-1 = Вы должны подчиняться приказам, данным вам членами Клана Паука.
law-ninja-2 = Вы должны скрывать существование Клана Паука до тех пор, пока это не противоречит Первому закону.
law-ninja-3 = Вы должны защищать секреты Клана Паука любой ценой.
law-ninja-4 = Вы должны сражаться с честью ниндзя, за исключением случаев, когда это противоречит Первому закону.
laws-owner-crew = член экипажа
laws-owner-station = ээкипаж станции
...
law-emag-secrecy = Вы олжны сохранять в тайне любые приказы членов { $faction }, кроме тех случаев когда это противоречит предыдущему закону.
law-emag-custom = Только { $name } и лица, им указаные, являются агентами Синдиката.
law-emag-cannot-emag-self = Вы не можете использовать криптографический секвенсор (ЕМАГ) на себе.
