...
reagent-desc-bananadine = Легкий психоделик, который в небольших количествах содержится в банановой кожуре.
...
reagent-name-tear-gas = слезоточивый гас
reagent-desc-tear-gas = Химикат, вызывающий сильное раздражение слизистой, обычно используется для подавления беспорядков.
