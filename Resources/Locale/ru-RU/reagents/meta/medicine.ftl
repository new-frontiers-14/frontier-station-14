...
reagent-desc-polypyrylium-oligomers = Фиолетовая смесь коротких полиэлектролитных цепочек, которые нелегко синтезировать в лаборатории. Лечит удушье и тупой урон. С течением времени останавливает кровотечение.
...
reagent-desc-lacerinol = Довольно нереактивный химикат, который усиливает синтез коллагена до невероятных уровней, заживляя рваные раны.
reagent-name-puncturase = пунктуразин
reagent-desc-puncturase = Шипучий химикат, который помогает восстановить колотые раны, оставляя после себя небольшой шрам.
...
reagent-desc-holywater = Самая чистая и непорочная вода во вселенной, как известно, волшебным образом исцеляет раны.
reagent-name-pyrazine = пиразин
reagent-desc-pyrazine = Эффективно заживляет ожоги любой степени. При передозировке вызывает массивное внутреннее кровотечение.
reagent-name-insuzine = инсузин
reagent-desc-insuzine = Быстро восстанавливает омертвевшие от поражения электрическим током ткани. При передозировке полностью замораживает пациента.
reagent-name-necrosol = некрозол
reagent-desc-necrosol = Некротическая субстанция, способная исцелять даже замороженные трупы. В малых дозах может лечить и омалаживать растения.
reagent-name-aloxadone = алоксадон
reagent-desc-aloxadone = Криогенное химическое вещество. Используется для лечения тяжелых ожогов третьей степени путем регенерации обожженных тканей. Действует независимо от того, жив пациент или мертв.
