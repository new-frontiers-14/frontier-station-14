...
reagent-desc-gastrotoxin = Умеренно токсичный побочный продукт разложения продуктов питания.
...
reagent-desc-vestine = Вызывает негативную реакцию в организме, приводя к сильному дрожанию. Хотя сам по себе он не особенно полезен, его можно использовать для производства небольшого количества химических веществ.
reagent-name-tazinide = тазинид
reagent-desc-tazinide = Очень опасная металлическая смесь, которая может препятствовать большинству движений посредством электрического тока.
