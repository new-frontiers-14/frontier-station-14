...
ui-vote-restart-fail-not-enough-ghost-players = Голосование за рестарт отклонено: Минимум { $ghostPlayerRequirement }% мертвых игроков требуется для начала голосования. На текущий момент недостаточно мёртвых игроков.
