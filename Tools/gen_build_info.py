...
BUILD_URL = f"https://arles-builds.station14.ru/{{FORK_ID}}/builds/{{FORK_VERSION}}/{FILE}"
MANIFEST_URL = f"https://arles-cdn.station14.ru/{{FORK_ID}}/version/{{FORK_VERSION}}/manifest"
MANIFEST_DOWNLOAD_URL = f"https://arles-cdn.station14.ru/{{FORK_ID}}/version/{{FORK_VERSION}}/download"
